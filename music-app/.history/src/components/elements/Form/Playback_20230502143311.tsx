...
const Playback = () => {
  ...
  return (
    <div className="px-[36px] flex items-center bg-slate-600 fixed bottom-0 w-full">
      <div className="flex-1 flex items-center justify-center justify-between py-6 space-x-5">
        <Controls
          isPlaying={playing}
          //   isActive={isActive}
          //   repeat={repeat}
