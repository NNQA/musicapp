...
function index() {
  ...
  return (
    <div className='px-20 pb-5'>
      <div className=''>
        <div className='bottom-0 flex relative space-x-8 items-center p-10 bg-gray-200'>
          <Image
            src={Userimg}
            alt="Image User"
            className='h-50 w-25 absolute rounded-md -bottom-2 bg-slate-50 p-2 shadow-md'>
