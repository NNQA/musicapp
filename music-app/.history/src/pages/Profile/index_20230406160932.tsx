      ...
      <div className='px-6 border-2 py-3 cursor-pointer w-full'>
        <div className='flex'>
          ...
          <div className='w-full'>
            ...
            <div className='p-2 flex' onClick={() => setAction(!action)}>
              <audio controls className='w-2/3 h-[24px]'>
                <source src={audio} type="audio/mpeg"
                />
              </audio>
              <div className='border-2 w-[60px] flex items-center space-x-5 px-2'>
      ...
      <div className='px-8 pt-4 border-2 pb-2 cursor-pointer w-full'>
        <div className='flex'>
          ...
          <div className='w-full'>
            ...
            <div className='p-2' onClick={() => setAction(!action)}>
