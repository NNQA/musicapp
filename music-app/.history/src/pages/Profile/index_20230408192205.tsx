...
function index() {
  ...
  function handlePreviousTrack() {
    const newIndex = currentTrackIndex - 1 < 0 ? tracks.length - 1 : currentTrackIndex - 1;
    setCurrentTrackIndex(newIndex);
  }

  function handleNextTrack() {
    const newIndex = currentTrackIndex + 1 >= tracks.length ? 0 : currentTrackIndex + 1;
    setCurrentTrackIndex(newIndex);
  }
