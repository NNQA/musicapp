...
function Upload({ data }: any) {
  ...
  return (
    <>
      {data === null ? (
        <div className="bg-[#1e1e1f] font-font-slide h-full text-white text-center">
            <p className="mt-[220px] text-3xl">Sorry you need to login to make this side effect</p>
            <p className="text-base">To login if you have account <Link href="/login">Login</Link></p>
        </div>
      ) : (
